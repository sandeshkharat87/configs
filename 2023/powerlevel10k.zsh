# Generated by Powerlevel10k configuration wizard on 2023-03-31 at 11:46 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    asdf                    # asdf version manager (https://github.com/asdf-vm/asdf)              # python virtual environment (https://docs.python.org/3/library/venv.html)
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=455
